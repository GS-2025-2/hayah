...
const sampleApplications = [
    { id: 1, company: 'Cortex', logo: cortexLogo, title: 'Analista de Fluxos e Processos', status: 'Entrevista com RH', closingDate: '20/12/2025', canSchedule: true, finished: false, url: '/vagas' },
    { id: 2, company: 'Cortex', logo: cortexLogo, title: 'Analista de Fluxos e Processos', status: 'Finalizada', closingDate: '20/12/2025', canSchedule: true, finished: false, url: '/vagas' },
];
